...
| **Error prevention** | 133 defect tests: each plants a real defect, asserts the contract refuses it, and restores the file — and each suite asserts its own case count |
...
| **Error prevention** | **133 of 133** defect kinds caught — each planted, refused, then removed; nothing is left in the tree, and a skipped case cannot print a pass | `atlas_test.py`, `agent_test.py` |
