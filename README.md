...
<p align="center">
  <a href="docs/VERSIONING.md">contract v2.17.0</a> ·
...
|---|---|---|
| contract version | **2.17.0** | `VERSION`, asserted identical in 6 other files |
...
| instruments | **23** | `atlas.yaml/instruments`, each naming its own limits |
| verification gate classes | **8** | `atlas.yaml/verification_policy/profiles` |
| task profiles | **14** | `atlas.yaml/task_profiles` |
| python files in the harness | **23** | `scripts/*.py`, all linted by ruff |
