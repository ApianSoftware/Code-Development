...
<p align="center">
  <a href="docs/VERSIONING.md">contract v2.20.0</a> ·
...
|---|---|---|
| contract version | **2.20.0** | `VERSION`, asserted identical in 6 other files |
...
| hard invariants | **30** | each CHECKED or DECLARED, never neither |
