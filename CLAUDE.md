# CLAUDE.md — Thea Software, contract v3.7.0
...
5. **Every limit names its closer.** All 39 instruments carry `proves`, `does_not_prove`
...
- …and 36 more in `atlas.yaml/agent_failure_modes`
