# CLAUDE.md — Thea Software, contract v3.6.0
...
5. **Every limit names its closer.** All 36 instruments carry `proves`, `does_not_prove`
...
- …and 34 more in `atlas.yaml/agent_failure_modes`
