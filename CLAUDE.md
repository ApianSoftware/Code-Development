# CLAUDE.md — Thea Software, contract v3.5.0
...
5. **Every limit names its closer.** All 34 instruments carry `proves`, `does_not_prove`
...
- `a_generator_that_reads_the_disk_not_the_tree` — a green pre-commit and a red Contract job on the same commit
...
- …and 30 more in `atlas.yaml/agent_failure_modes`
