# AGENTS.md — Thea Software, contract v3.18.0
...
5. **Every limit names its closer.** All 48 instruments carry `proves`, `does_not_prove`
...
- …and 39 more in `atlas.yaml/agent_failure_modes`
