# AGENTS.md — Thea Software, contract v3.15.0
...
5. **Every limit names its closer.** All 45 instruments carry `proves`, `does_not_prove`
...
- …and 38 more in `atlas.yaml/agent_failure_modes`
