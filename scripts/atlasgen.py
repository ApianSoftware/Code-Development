...
def claude_md() -> str:
    """AGENTS.md BY IMPORT, NOT BY COPY (3.10.0): Claude Code expands `@path` (code.claude.com/docs/en/memory),
    so one body generated twice is now one import plus what is Claude's; contextcost counts the import."""
