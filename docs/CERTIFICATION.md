...
| `delegate.py` | every handoff to another agent carries a goal, a scope, an acceptance command, a return shape, what is forbidden and whether it… | that the delegate obeyed the brief, or that its answer is right |
