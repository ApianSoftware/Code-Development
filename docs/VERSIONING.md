...
Same-commit rule: contract, route, MCP role, CI/security policy, verification requirement, canonical structure, or repository operating policy changes update MODEL.md, VERSION, README.md, affected docs/patterns/adapters, and atlas.yaml together.
...
0.9.7 YAML-parsed harness, single-sourced task profiles, directory routing, manifest schema check, generated language index, label check, CodeQL confirmed as default setup, counts printed
